...
$ df
```
Cette commande permet la quantité d'espace disque utilisée ainsi que la quantité d'espace libre disponible.
___
#### STDERR and STDOUT redirection operator
>&>

Cet opérateur permet de créer un nouveau fichier contenant les "standard error" et les "stanndard output".
___
